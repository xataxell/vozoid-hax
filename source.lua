...
function library:GetThemes()
    local themes = {"Default", "Midnight", 'Gamesense'}
...
function library:Watermark(str)
    ...
    function watermarktypes:SetPosition(X, Y)
        ...
        local x = math.clamp((X / 100) * (ScreenSize.X - watermark.Size.X.Offset), 0, ScreenSize.X - watermark.Size.X.Offset)
        ...
        function tabtypes:Section(options)
            ...
            function sectiontypes:Toggle(options)
                ...
                function toggletypes:Slider(options)
                    ...
                    section.Size = UDim2.new(1, 0, 0, sectioncontent.AbsoluteContentSize + 48)
